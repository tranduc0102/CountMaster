...
namespace Watermelon
{
    ...
    public static class EditorCustomStyles
    {
        ...
        private static EditorCustomStylesData editorCustomStyles;
        ...
        private static void LoadStylesData()
        {
            ...
            else
            {
                ...
                {
                    Debug.LogError("EditorCustomStylesData asset is required for the proper work of the project. Reimport the CORE package to resolve this issue.");
                }
            }
        }
        ...
        public static Texture2D GetMissingIcon()
        {
            ...
            return editorCustomStyles.MissingIcon;
        }
