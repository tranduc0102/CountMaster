...
namespace Watermelon
{
    ...
    public sealed class MonoBehaviorEditor : WatermelonEditor { }

    [CanEditMultipleObjects]
    [CustomEditor(typeof(ScriptableObject), true)]
    public sealed class ScriptableObjectEditor : WatermelonEditor { }
    ...
    public class WatermelonEditor : Editor
    {
        ...
        public FieldInfo GetField(string name)
        {
            ...
            {
                FieldInfo fieldInfo = type.GetField(name, BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static);
                if (fieldInfo != null)
                    return fieldInfo;
            }
        ...
        private List<FieldInfo> GetFields(Func<FieldInfo, bool> predicate)
        {
            ...
            foreach (var type in nestedClassTypes)
            {
                IEnumerable<FieldInfo> fieldInfos = type.GetFields(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static).Where(predicate);
        ...
        private List<PropertyInfo> GetProperties(Func<PropertyInfo, bool> predicate)
        {
            ...
            foreach (var type in nestedClassTypes)
            {
                IEnumerable<PropertyInfo> propertyInfos = type.GetProperties(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static).Where(predicate);
        ...
        public class EditorTabs
        {
            ...
            public EditorTabs(WatermelonEditor editor, IEnumerable<GUIRenderer> renderers)
            {
                this.editor = editor;
            ...
            private class Tab
            {
                ...
                public Tab(WatermelonEditor editor, TabAttribute tabAttribute, IEnumerable<GUIRenderer> renderers)
                {
                    this.editor = editor;
